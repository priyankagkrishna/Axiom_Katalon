...
WebUI.comment('----------------Item Addition In Purchase Order----------')

CustomKeywords.'purchaseOrder.PurchaseOrderCreation.ItemAdditioninPurchaseOrder'()

WebUI.comment('----------------Navigate to Receiving Page----------')

CustomKeywords.'purchaseOrder.OperationsReceiving.navigatetoReceivingPage'()
